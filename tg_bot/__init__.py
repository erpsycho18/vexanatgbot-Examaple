...
#print(flag)
log = logging.getLogger('[VexanaFanClub]')
logging.getLogger('ptbcontrib.postgres_persistence.postgrespersistence').setLevel(logging.WARNING)
log.info("[Vexana] Kigyo is starting. | An Eagle Union Project. | Licensed under GPLv3.")
log.info("[Vexana] Not affiliated to Azur Lane or Yostar in any way whatsoever.")
log.info("[Vexana] Project maintained by: github.com/aksr-aashish (t.me/itzz_Axel1)")
